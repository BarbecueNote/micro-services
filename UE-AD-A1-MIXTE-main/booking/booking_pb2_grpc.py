...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddBooking = channel.unary_stream(
                '/Booking/AddBooking',
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddBooking': grpc.unary_stream_rpc_method_handler(
                    servicer.AddBooking,
...
class Booking(object):
    ...
    def AddBooking(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/Booking/AddBooking',
